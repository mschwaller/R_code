...
basin_latlon <- spTransform(basin, lat_lon_projection) # convert the nhgis0042_shapefile_tl2016_us_county_2016 projection to geographic lat,lon
plot(basin_latlon, xlim=c(-80.0,-75.0), ylim=c(34.0, 36.5))
